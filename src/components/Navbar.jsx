      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-10 lg:gap-12">
          ...
          <a
            ...
            className="ml-4 flex items-center gap-2 text-xs uppercase tracking-[0.15em] bg-brand/10 hover:bg-brand/20 text-brand border border-brand/20 hover:border-brand/40 px-6 py-2.5 rounded-full transition-all duration-300"
          >
